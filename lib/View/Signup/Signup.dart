        ...
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration:
                  FormInputDecoration.FormInputDesign(name: "Име и Презиме"),
            ...
            TextFormField(
              ...
              textAlign: TextAlign.center,
              textCapitalization: TextCapitalization.none,
              decoration: FormInputDecoration.FormInputDesign(name: "Е-адреса"),
              onFieldSubmitted: (node) {
                email!.unfocus();
            ...
            TextFormField(
              ...
              textCapitalization: TextCapitalization.none,
              decoration:
                  FormInputDecoration.FormInputDesign(name: "Внесете лозинка"),
              onFieldSubmitted: (node) {
                password!.unfocus();
